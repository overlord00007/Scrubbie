...
function randomNameGen() {
    var nameList = [ "Yuvraj", "Rahul", "Aditya", "King","Buddy", "King", "Champ", "Bro", "Amigo", "Tiny", "Chief", "Pal", "Bee", "Boo", "Bug", "Scout", "Boomer", "Punk", "Ace" , "Lord" ,"Gojo" , " Tamer"];
